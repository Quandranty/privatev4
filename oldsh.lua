...
local cornerOrbit = Instance.new("UICorner")
local cornerWhitelistPlayer = Instance.new("UICorner")
local cornerFarmBlacklist = Instance.new("UICorner")
local cornerTeleport = Instance.new("UICorner")
local cornerRemoveWhitelist = Instance.new("UICorner")
local cornerAddToBlacklist = Instance.new("UICorner")
local cornerRemoveFromBlacklist = Instance.new("UICorner")
local cornerPrintFarmList = Instance.new("UICorner")
local cornerKillAura = Instance.new("UICorner")
local cornerBowAura = Instance.new("UICorner")
...
local trinitySinityChar = game.Players.TrinitySinity.Character
local trinitySinity = game.Players.TrinitySinity.Character.HumanoidRootPart
local trinitSinityHumanoid = trinitySinityChar.Humanoid
Farming = {"MackenzieBenton4", "SisterPhyster", "CherylHayes4", "ShellyJordan5", "BrianKhan16", "LynnRollins9", "Diggy2x", "sahko333", "sVs_Thunder", "mmffevh55", "LindsayCarter2", "DouglasFoster4","MarisaMoore5", "meliodas_king102929", "Kaonlaadriann", "godlyzballer_222"}
Whitelist = {}

Bots = {"SIagathor","Drifter0507","deathfelller","Skadistic","Aneotic","UnHolyGainz","LibLikesMen","KTrillion338","PBP_Lifter","drrifterr"}
...
dummyButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
dummyButton.Font = Enum.Font.Fantasy
...
Creds.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
Creds.Font = Enum.Font.Fantasy
Creds.Text = "FRANK MWR V4"
Creds.TextColor3 = Color3.fromRGB(135,135,135)
Creds.TextScaled = true
Creds.TextSize = 10.000
Creds.TextWrapped = true
Creds.MouseEnter:Connect(function()
    Creds.Text = "Proximity#0429"
end)
Creds.MouseLeave:Connect(function()
    Creds.Text = "Frank MWR V4"
end)
...
OrbitButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
OrbitButton.Font = Enum.Font.Fantasy
...
cornerOrbit.Parent = OrbitButton
...
WhitelistButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
WhitelistButton.Font = Enum.Font.Fantasy
...
cornerWhitelistPlayer.Parent = WhitelistButton
...
FarmPlayerButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
FarmPlayerButton.Font = Enum.Font.Fantasy
...
cornerFarmBlacklist.Parent = FarmPlayerButton
		...
		coroutine.wrap(function()
			...
			repeat wait()
				...
				if (ClosestCharacter) then
					...
					local vx = Vector3.new(trinitySinity.Position.X + 2, trinitySinity.Position.Y, trinitySinity.Position.Z + 6)
					if (Client.Team == greywolf) then
						Client.Character.HumanoidRootPart.CFrame = CFrame.new(vx)
...
TeleportButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
TeleportButton.Font = Enum.Font.Fantasy
...
AddToFarmButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
AddToFarmButton.Font = Enum.Font.Fantasy
...
cornerAddToBlacklist.Parent = AddToFarmButton
...
RemoveFarmButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
RemoveFarmButton.Font = Enum.Font.Fantasy
...
cornerRemoveFromBlacklist.Parent = RemoveFarmButton
...
PrintFarmingButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
PrintFarmingButton.Font = Enum.Font.Fantasy
...
cornerPrintFarmList.Parent = PrintFarmingButton
...
KillAuraButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
KillAuraButton.Font = Enum.Font.Fantasy
...
cornerKillAura.Parent = KillAuraButton
...
BowAuraButton.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
BowAuraButton.Font = Enum.Font.Fantasy
...
cornerBowAura.Parent = BowAuraButton
...
RemoveWhitelist.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
RemoveWhitelist.Font = Enum.Font.Fantasy
...
cornerRemoveWhitelist.Parent = RemoveWhitelist
...
SelectedPlayer.BackgroundColor3 = Color3.fromRGB(135,135,135)
...
SelectedPlayer.Font = Enum.Font.Fantasy
SelectedPlayer.Text = "Selected Player:"
SelectedPlayer.TextColor3 = Color3.fromRGB(135, 135, 135)
